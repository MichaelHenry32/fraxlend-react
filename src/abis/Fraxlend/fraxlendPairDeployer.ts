export const FraxlendPairDeployerAbi = [
  ...
  { inputs: [], name: "CircuitBreakerOnly", type: "error" },
  ...
  {
    inputs: [],
    name: "fraxlendPairRegistryAddress",
    outputs: [{ internalType: "address", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    ...
    outputs: [
      { internalType: "address[]", name: "_deployedPairs", type: "address[]" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "address[]", name: "_swappers", type: "address[]" },
    ],
